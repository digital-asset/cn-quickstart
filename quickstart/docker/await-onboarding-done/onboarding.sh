...
create_user "$APP_PROVIDER_PARTICIPANT_ADMIN_TOKEN" $AUTH_APP_PROVIDER_BACKEND_TO_PARTICIPANT_USER_ID $AUTH_APP_PROVIDER_BACKEND_TO_PARTICIPANT_USER_NAME "" participant-app-provider
grant_rights "$APP_PROVIDER_PARTICIPANT_ADMIN_TOKEN" $AUTH_APP_PROVIDER_BACKEND_TO_PARTICIPANT_USER_ID $APP_PROVIDER_PARTY "ReadAs ActAs" participant-app-provider
